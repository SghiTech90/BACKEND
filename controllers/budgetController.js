...
const getTableBudgetCount = async (pool, tableName) => {
  const querey = `SELECT COUNT(*) as count FROM ${tableName}`;
...
const getTableUpvibhagCounts = async (pool, tableName) => {
  const querey = `SELECT Upvibhag, COUNT(*) as count FROM ${tableName} GROUP BY Upvibhag`;
  const result = await pool.request().query(query);
...
const getUniqueYears = async (req, res) => {
  ...
  try {
    ...
    const querey = `SELECT DISTINCT Arthsankalpiyyear FROM BuildingProvision ORDER BY Arthsankalpiyyear DESC`;
    const result = await pool.request().query(query);
...
const getUniqueHeadNames = async (req, res) => {
  ...
  try {
    ...
    const querey = `SELECT DISTINCT LekhaShirshName FROM BudgetMasterBuilding WHERE LekhaShirshName IS NOT NULL ORDER BY LekhaShirshName`;
    const result = await pool.request().query(query);
...
const BudgetMasterDepositFund = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT a.[Sadyasthiti]as 'Work Status', Count(a.[Sadyasthiti])as'Total Work',sum(cast(a.[PrashaskiyAmt] as decimal(10,2))) as 'Estimated Cost',sum(cast(a.[TrantrikAmt]as decimal(10,2)))as 'T.S Cost',sum(cast(b.[Tartud]as decimal(10,2))) as 'Budget Provision 2023-2024',sum(cast(b.[AikunKharch]as decimal(10,2))) as 'Expenditure 2023-2024' FROM BudgetMasterDepositFund a full outer join DepositFundProvision  b on a.workid=b.workid and b.Arthsankalpiyyear='2023-2024' where a.[Sadyasthiti]IS NOT NULL   GROUP BY a.[Sadyasthiti] order by case a.[Sadyasthiti] when N'पूर्ण' then 1 when N'Completed' then 1 when N'Incomplete' then 2 when N'अपूर्ण' then 2 when N'प्रगतीत' then 3 when N'Inprogress' then 3 when N'Processing' then 3 when N'Current' then 3 when N'चालू' then 3  when N'Tender Stage' then 4 when N'निविदा स्तर' then 4 when N'Estimated Stage' then 5 when N'अंदाजपत्रकिय स्थर' then 5 when N'अंदाजपत्रकीय स्तर' then 5 when N'Not Started' then 6 when N'सुरु न झालेली' then 6 when N'सुरू करणे' then 7 when N'' then 8 end`;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
...
const BudgetMasterGAT_A = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT a.[Sadyasthiti]as 'Work Status', Count(a.[Sadyasthiti])as'Total Work',sum(cast(a.[PrashaskiyAmt] as decimal(10,2))) as 'Estimated Cost',sum(cast(a.[TrantrikAmt]as decimal(10,2)))as 'T.S Cost',sum(cast(b.[Tartud]as decimal(10,2))) as 'Budget Provision 2023-2024',sum(cast(b.[AikunKharch]as decimal(10,2))) as 'Expenditure 2023-2024' FROM BudgetMasterGAT_A a full outer join GAT_AProvision  b on a.workid=b.workid and b.Arthsankalpiyyear='2023-2024' where a.[Sadyasthiti]IS NOT NULL    GROUP BY a.[Sadyasthiti] order by case a.[Sadyasthiti] when N'पूर्ण' then 1 when N'Completed' then 1 when N'Incomplete' then 2 when N'अपूर्ण' then 2 when N'प्रगतीत' then 3 when N'Inprogress' then 3 when N'Processing' then 3 when N'Current' then 3 when N'चालू' then 3  when N'Tender Stage' then 4 when N'निविदा स्तर' then 4 when N'Estimated Stage' then 5 when N'अंदाजपत्रकिय स्थर' then 5 when N'अंदाजपत्रकीय स्तर' then 5 when N'Not Started' then 6 when N'सुरु न झालेली' then 6 when N'सुरू करणे' then 7 when N'' then 8 end`;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
...
const BudgetMasterGAT_D = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT a.[Sadyasthiti]as 'Work Status', Count(a.[Sadyasthiti])as'Total Work',sum(cast(a.[PrashaskiyAmt] as decimal(10,2))) as 'Estimated Cost',sum(cast(a.[TrantrikAmt]as decimal(10,2)))as 'T.S Cost',sum(cast(b.[Tartud]as decimal(10,2))) as 'Budget Provision 2023-2024',sum(cast(b.[AikunKharch]as decimal(10,2))) as 'Expenditure 2023-2024' FROM BudgetMasterGAT_D a full outer join GAT_DProvision  b on a.workid=b.workid and b.Arthsankalpiyyear='2023-2024' where a.[Sadyasthiti]IS NOT NULL   GROUP BY a.[Sadyasthiti] order by case a.[Sadyasthiti] when N'पूर्ण' then 1 when N'Completed' then 1 when N'Incomplete' then 2 when N'अपूर्ण' then 2 when N'प्रगतीत' then 3 when N'Inprogress' then 3 when N'Processing' then 3 when N'Current' then 3 when N'चालू' then 3  when N'Tender Stage' then 4 when N'निविदा स्तर' then 4 when N'Estimated Stage' then 5 when N'अंदाजपत्रकिय स्थर' then 5 when N'अंदाजपत्रकीय स्तर' then 5 when N'Not Started' then 6 when N'सुरु न झालेली' then 6 when N'सुरू करणे' then 7 when N'' then 8 end`;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
...
const BudgetMasterGAT_FBC = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT a.[Sadyasthiti]as 'Work Status', Count(a.[Sadyasthiti])as'Total Work',sum(cast(a.[PrashaskiyAmt] as decimal(10,2))) as 'Estimated Cost',sum(cast(a.[TrantrikAmt]as decimal(10,2)))as 'T.S Cost',sum(cast(b.[Tartud]as decimal(10,2))) as 'Budget Provision 2023-2024',sum(cast(b.[AikunKharch]as decimal(10,2))) as 'Expenditure 2023-2024' FROM BudgetMasterGAT_FBC a full outer join GAT_FBCProvision  b on a.workid=b.workid and b.Arthsankalpiyyear='2023-2024' where a.[Sadyasthiti]IS NOT NULL    GROUP BY a.[Sadyasthiti] order by case a.[Sadyasthiti] when N'पूर्ण' then 1 when N'Completed' then 1 when N'Incomplete' then 2 when N'अपूर्ण' then 2 when N'प्रगतीत' then 3 when N'Inprogress' then 3 when N'Processing' then 3 when N'Current' then 3 when N'चालू' then 3  when N'Tender Stage' then 4 when N'निविदा स्तर' then 4 when N'Estimated Stage' then 5 when N'अंदाजपत्रकिय स्थर' then 5 when N'अंदाजपत्रकीय स्तर' then 5 when N'Not Started' then 6 when N'सुरु न झालेली' then 6 when N'सुरू करणे' then 7 when N'' then 8 end`;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
...
const BudgetMasterMLA = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT a.[Sadyasthiti]as 'Work Status', Count(a.[Sadyasthiti])as'Total Work',sum(cast(a.[PrashaskiyAmt] as decimal(10,2))) as 'Estimated Cost',sum(cast(a.[TrantrikAmt]as decimal(10,2)))as 'T.S Cost',sum(cast(b.[Tartud]as decimal(10,2))) as 'Budget Provision 2023-2024',sum(cast(b.[AikunKharch]as decimal(10,2))) as 'Expenditure 2023-2024' FROM BudgetMasterMLA a full outer join MLAProvision  b on a.workid=b.workid and b.Arthsankalpiyyear='2023-2024' where a.[Sadyasthiti]IS NOT NULL   GROUP BY a.[Sadyasthiti] order by case a.[Sadyasthiti] when N'पूर्ण' then 1 when N'Completed' then 1 when N'Incomplete' then 2 when N'अपूर्ण' then 2 when N'प्रगतीत' then 3 when N'Inprogress' then 3 when N'Processing' then 3 when N'Current' then 3 when N'चालू' then 3  when N'Tender Stage' then 4 when N'निविदा स्तर' then 4 when N'Estimated Stage' then 5 when N'अंदाजपत्रकिय स्थर' then 5 when N'अंदाजपत्रकीय स्तर' then 5 when N'Not Started' then 6 when N'सुरु न झालेली' then 6 when N'सुरू करणे' then 7 when N'' then 8 end`;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
...
const BudgetMasterMP = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT a.[Sadyasthiti]as 'Work Status', Count(a.[Sadyasthiti])as'Total Work',sum(cast(a.[PrashaskiyAmt] as decimal(10,2))) as 'Estimated Cost',sum(cast(a.[TrantrikAmt]as decimal(10,2)))as 'T.S Cost',sum(cast(b.[Tartud]as decimal(10,2))) as 'Budget Provision 2023-2024',sum(cast(b.[AikunKharch]as decimal(10,2))) as 'Expenditure 2023-2024' FROM BudgetMasterMP a full outer join MPProvision  b on a.workid=b.workid and b.Arthsankalpiyyear='2023-2024' where a.[Sadyasthiti]IS NOT NULL   GROUP BY a.[Sadyasthiti] order by case a.[Sadyasthiti] when N'पूर्ण' then 1 when N'Completed' then 1 when N'Incomplete' then 2 when N'अपूर्ण' then 2 when N'प्रगतीत' then 3 when N'Inprogress' then 3 when N'Processing' then 3 when N'Current' then 3 when N'चालू' then 3  when N'Tender Stage' then 4 when N'निविदा स्तर' then 4 when N'Estimated Stage' then 5 when N'अंदाजपत्रकिय स्थर' then 5 when N'अंदाजपत्रकीय स्तर' then 5 when N'Not Started' then 6 when N'सुरु न झालेली' then 6 when N'सुरू करणे' then 7 when N'' then 8 end`;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error("Error getting BudgetMaster2515 details:", error);
...
const BudgetMasterRoad = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `
    SELECT a.[Sadyasthiti]as 'Work Status', Count(a.[Sadyasthiti])as'Total Work',sum(cast(a.[PrashaskiyAmt] as decimal(10,2))) as 'Estimated Cost',sum(cast(a.[TrantrikAmt]as decimal(10,2)))as 'T.S Cost',sum(cast(b.[Tartud]as decimal(10,2))) as 'Budget Provision 2022-2023',sum(cast(b.[AikunKharch]as decimal(10,2))) as 'Expenditure 2022-2023' FROM BudgetMasterRoad a full outer join RoadProvision  b on a.workid=b.workid where a.[Sadyasthiti]IS NOT NULL and b.Arthsankalpiyyear='2022-2023'   GROUP BY a.[Sadyasthiti] order by case a.[Sadyasthiti] when N'पूर्ण' then 1 when N'Completed' then 1 when N'Incomplete' then 2 when N'अपूर्ण' then 2 when N'प्रगतीत' then 3 when N'Inprogress' then 3 when N'Processing' then 3 when N'Current' then 3 when N'चालू' then 3  when N'Tender Stage' then 4 when N'निविदा स्तर' then 4 when N'Estimated Stage' then 5 when N'अंदाजपत्रकिय स्थर' then 5 when N'अंदाजपत्रकीय स्तर' then 5 when N'Not Started' then 6 when N'सुरु न झालेली' then 6 when N'सुरू करणे' then 7 when N'' then 8 end`;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error("Error getting BudgetMaster2515 details:", error);
...
const ContNonResidentialBuilding2909 = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `
SELECT a.[Sadyasthiti]as 'Work Status', Count(a.[Sadyasthiti])as'Total Work',sum(cast(a.[PrashaskiyAmt] as decimal(10,2))) as 'AA cost Rs in lakhs',sum(cast(a.[TrantrikAmt]as decimal(10,2)))as 'Technical Sanction Cost Rs in Lakh',sum(cast(b.[Tartud]as decimal(10,2))) as 'Total Provision Rs in Lakh',sum(cast(b.[AikunKharch]as decimal(10,2))) as 'Total Expense Rs in Lakh' FROM BudgetMasterNonResidentialBuilding  a full outer join NonResidentialBuildingProvision  b on a.workid=b.workid where a.[Sadyasthiti]!='' and ThekedaarName=@name and b.Arthsankalpiyyear='2022-2023' GROUP BY a.[Sadyasthiti]`;
    const result = await pool.request().input("name", name).query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error(
...
const ContUpdPanelCrf = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT  [WorkId] as 'वर्क आयडी',[Arthsankalpiyyear] as 'अर्थसंकल्पीय वर्ष',[KamacheName] as 'कामाचे नाव',[Shera] as 'शेरा'  from BudgetMasterCRF   where ShakhaAbhyantaName=@name  or [UpabhyantaName]=@name  or ThekedaarName=@name `;
    const result = await pool.request().input("name", name).query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error(
...
const ContUpdPanelNABARD = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT  [WorkId] as 'वर्क आयडी',[Arthsankalpiyyear] as 'अर्थसंकल्पीय वर्ष',[KamacheName] as 'कामाचे नाव',[Shera] as 'शेरा'  from BudgetMasterNabard   where ShakhaAbhyantaName=@name  or [UpabhyantaName]=@name  or ThekedaarName=@name  `;
    const result = await pool.request().input("name", name).query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error(
...
const ContUpdPanelROAD = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT  [WorkId] as 'वर्क आयडी',[Arthsankalpiyyear] as 'अर्थसंकल्पीय वर्ष',[KamacheName] as 'कामाचे नाव',[Shera] as 'शेरा'  from BudgetMasterRoad   where ShakhaAbhyantaName=@name  or [UpabhyantaName]=@name  or ThekedaarName=@name    `;
    const result = await pool.request().input("name", name).query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error(
...
const ContUpdPanelAunty = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `SELECT  [WorkId] as 'वर्क आयडी',[Arthsankalpiyyear] as 'अर्थसंकल्पीय वर्ष',[KamacheName] as 'कामाचे नाव',[Shera] as 'शेरा'  from BudgetMasterAunty   where ShakhaAbhyantaName=@name  or [UpabhyantaName]=@name  or ThekedaarName=@name   `;
    const result = await pool.request().input("name", name).query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error(
...
const ContUpdPhotoBuilding = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `Select [ImageId], [WorkId],[Image],[Description] from ImageGallary where WorkId='220348400046.00' and Type='Building' order by ImageId desc `;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error(
...
const ContUpdPhotoCrf = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `Select [ImageId], [WorkId],[Image],[Description] from ImageGallary where WorkId='2212000400047' and Type='CRF' order by ImageId desc
 `;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
...
const ContUpdPhotoNabard = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `Select [ImageId], [WorkId],[Image],[Description] from ImageGallary where WorkId='2212000400047' and Type='Nabard' order by ImageId desc  `;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error(
...
const ContUpdPhotoRoad = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    const querey = `Select [ImageId], [WorkId],[Image],[Description] from ImageGallary where WorkId='2212000400047' and Type='Road' order by ImageId desc   `;
    const result = await pool.request().query(query);
    res.json({ success: true, data: result.recordset });
  } catch (error) {
    console.error(
...
const allImage = async (req, res) => {
  const { office, page = 1, pageSize = 20, includeImage = true } = req.body;
  ...
  try {
    ...
    const baseColumns = `
      ...
      Latitude,
      ContentType,
      DATALENGTH(Image) AS ImageBytes
    `;

    const dataQuery = `
      SELECT ${baseColumns}${includeImage ? ", Image" : ""}
      FROM [ImageGallary]
      ORDER BY ImageId
    ...
    const images = dataResult.recordset.map((row) => {
      const baseResponse = {
        ...
        sizeInBytes: row.ImageBytes,
      };

      if (includeImage && row.Image) {
        baseResponse.image = `data:${row.ContentType};base64,${Buffer.from(
          row.Image
        ).toString("base64")}`;
      }
...
const EEUpdPanelROAD = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    //const querey = `SELECT  [WorkId] as 'वर्क आयडी',[Arthsankalpiyyear] as 'अर्थसंकल्पीय वर्ष',[KamacheName] as 'कामाचे नाव',[Shera] as 'शेरा'  from BudgetMasterRoad  `;
const querey = `SELECT 
    B.[WorkId] AS 'वर्क आयडी',
    B.[Arthsankalpiyyear] AS 'अर्थसंकल्पीय वर्ष',
    B.[KamacheName] AS 'कामाचे नाव',
...
const EEUpdPanelAunty = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    //const querey = `SELECT  [WorkId] as 'वर्क आयडी',[Arthsankalpiyyear] as 'अर्थसंकल्पीय वर्ष',[KamacheName] as 'कामाचे नाव',[Shera] as 'शेरा'  from BudgetMasterAunty  `;
const querey = `SELECT 
    B.[WorkId] AS 'वर्क आयडी',
    B.[Arthsankalpiyyear] AS 'अर्थसंकल्पीय वर्ष',
    B.[KamacheName] AS 'कामाचे नाव',
...
const EEUpdPanelNABARD = async (req, res) => {
  ...
  try {
    ...
    // Example: Detailed query on Building tables, adjust as needed
    //const querey = `SELECT  [WorkId] as 'वर्क आयडी',[Arthsankalpiyyear] as 'अर्थसंकल्पीय वर्ष',[KamacheName] as 'कामाचे नाव',[Shera] as 'शेरा'  from BudgetMasterNABARD  `;
const querey = `SELECT 
    B.[WorkId] AS 'वर्क आयडी',
    B.[Arthsankalpiyyear] AS 'अर्थसंकल्पीय वर्ष',
    B.[KamacheName] AS 'कामाचे नाव',
...
const UpdateStatusBuilding = async (req, res) => {
  ...
  try {
    ...
    // `;
    const querey = `update BudgetMasterBuilding 
	  SET Shera = @Status
    WHERE [WorkId] = @WorkId`;
...
const getCircleNotificationTotal = async (req, res) => {
  ...
  try {
    ...
    const urls = [
      "https://Sghitech.up.railway.app/budget/CircleNotificationToday",
      "https://Sghitech.up.railway.app/budget/CircleNotificationWeek",
      "https://Sghitech.up.railway.app/budget/CircleNotificationHalfMonth",
      "https://Sghitech.up.railway.app/budget/CircleNotificationMonth",
    ];
...
const getBudgetData = (tableName) => {
  return async (req, res) => {
    ...
    try {
      ...
      const querey = `SELECT WorkId, KamacheName ${tableName}`;
      const result = await pool.request().query(query);
